...
const Item = ({ name, mobile, email, link }) => (
    ...
    <Card.Content>
        ...
        />
            <TouchableOpacity style={{flexDirection: 'row', marginTop: 10, marginBottom: 10, backgroundColor: '#B0E0E6', height: 40, width: 150, borderTopLeftRadius: 0, borderBottomLeftRadius: 20, borderTopRightRadius: 20, borderBottomRightRadius: 0, alignItems: 'center', justifyContent: 'center'}} onPress={()=>Linking.openURL(link)}>
